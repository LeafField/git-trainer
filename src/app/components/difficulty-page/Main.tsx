...
const MainPage: FC<Props> = ({ data, title }) => {
  ...
  return (
    <div className="mx-auto  grid h-[calc(100svh-2.81rem)] max-w-[120rem] grid-rows-[auto_1fr] gap-x-9  gap-y-8 px-7 lg:grid-cols-[minmax(0,25rem)_1fr_1fr] lg:gap-y-[7rem]">
